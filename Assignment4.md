...
1.  **Run Mutation Testing on the sample test cases**
...
>   Try to come up with a way that you could automatically detect a few
...
3.  UI test cases are sequence of events on the GUI/web interface.
